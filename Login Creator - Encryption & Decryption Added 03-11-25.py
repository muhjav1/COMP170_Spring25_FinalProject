...
def prompt_decryption():
    login_request = input("Would you like to retrieve your login information? Y / N?") # Prompts user whether they would like to retrieve any stored logins
    if login_request.lower() == "y":
        decrypted_data = decrypt("passwords.txt")  # Decrypts data from the "passwords" file
        print()
        print("Your decrypted login information is: ",decrypted_data) # Prints decrypted login to user
    else:
